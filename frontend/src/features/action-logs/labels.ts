...
export const EVENT_ACCORDION_GROUPS: Array<{
...
}> = [
  {
    ...
    events: [
      ...
      { key: "messageDeleteBulk", label: "Eliminación en masa (purge)" },
    ],
  },
  {
    id: "members",
    ...
    events: [
      ...
      { key: "memberKick", label: "Kick (expulsión)" },
      ...
      { key: "memberUntimeout", label: "Timeout levantado" },
  ...
  },
  {
    ...
    events: [
      ...
      { key: "threadCreate", label: "Hilo creado" },
      { key: "threadDelete", label: "Hilo eliminado" },
      { key: "threadUpdate", label: "Hilo actualizado (nombre / archivo)" },
      { key: "guildUpdate", label: "Servidor (nombre, icono, vanity)" },
    ],
  },
  {
    id: "voice",
