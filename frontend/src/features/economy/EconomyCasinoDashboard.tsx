...
import { defaultEconomyCasinoConfig } from "@adobos/shared";
import {
              ...
              <TabsContent>
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="cf-mult">Multiplicador de ganancia</Label>
                      <Input
                        id="cf-mult"
                        type="number"
                        min={0.1}
              ...
              <TabsContent>
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                      Reglas de mesa para la mano natural y el double down.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setConfig((c) => ({
                            ...
                            blackjack: {
                              ...c.blackjack,
                              blackjackMultiplier: Number(e.target.value) || 0,
                            },
                          }))
                        }
                      />
